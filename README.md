...
cur = conn.cursor()
cur.execute("SELECT id, name FROM presets WHERE is_deleted = 0")
print(cur.fetchall())
conn.close()
```
...
├── clear_all_caches.ps1        # Server restart script
├── purge_and_restart.ps1       # Full purge + restart
└── README.md                   # This file
```
