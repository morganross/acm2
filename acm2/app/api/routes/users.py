...
- Individual user_{uuid}.db files for each user's data
- API keys with embedded UUID for O(1) lookup
...
class CreateUserRequest(BaseModel):
    ...
    No username. No WordPress numeric ID. UUID is the only identifier.
    """
